...
const i18n = defineMessages({
  ...
  deeplinkPlaceholder: {
    ...
    defaultMessage: 'Paste your warmachine://recipe?config=... deeplink here',
  },
  deeplinkHint: {
    id: 'importRecipeForm.deeplinkHint',
    defaultMessage: 'Paste a recipe deeplink starting with "warmachine://recipe?config="',
  },
  or: {
  ...
  reviewWarning: {
    ...
    defaultMessage: 'Ensure you review contents of recipe files before adding them to your warmachine interface.',
  },
  cancel: {
...
const importRecipeSchema = z
  .object({
    deeplink: z
      .string()
      .refine(
        (value) => !value || value.trim().startsWith('warmachine://recipe?config='),
        'Invalid deeplink format. Expected: warmachine://recipe?config=...'
      ),
    recipeUploadFile: z
      .instanceof(File)
      .nullable()
