...
A tiny [Open Plugins](https://open-plugins.com) plugin that demonstrates warmachine's
...
WarMachine discovers plugins under `~/.agents/plugins/<name>/` (user scope) and
...
# Then run warmachine normally; you should see lines like
