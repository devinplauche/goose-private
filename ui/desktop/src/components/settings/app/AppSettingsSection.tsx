...
import ThemeSelector from '../../WarMachineSidebar/ThemeSelector';
...
const i18n = defineMessages({
  ...
  appearanceDesc: {
    ...
    defaultMessage: 'Configure how warmachine appears on your system',
  },
  ...
  taskNotificationsDesc: {
    ...
    defaultMessage: 'Notify when WarMachine finishes a task while the window is in the background',
  },
  menuBarIcon: { id: 'settings.menuBarIcon.title', defaultMessage: 'Menu bar icon' },
  menuBarIconDesc: {
    id: 'settings.menuBarIcon.description',
    defaultMessage: 'Show warmachine in the menu bar',
  },
  dockIcon: { id: 'settings.dockIcon.title', defaultMessage: 'Dock icon' },
  dockIconDesc: { id: 'settings.dockIcon.description', defaultMessage: 'Show warmachine in the dock' },
  preventSleep: { id: 'settings.preventSleep.title', defaultMessage: 'Prevent Sleep' },
  preventSleepDesc: {
    id: 'settings.preventSleep.description',
    defaultMessage:
      'Keep your computer awake while warmachine is running a task (screen can still lock)',
  },
  ...
  themeDesc: {
    ...
    defaultMessage: 'Customize the look and feel of warmachine',
  },
  languageTitle: { id: 'settings.language.title', defaultMessage: 'Language' },
  languageDesc: {
    id: 'settings.language.description',
    defaultMessage: 'Choose the display language for warmachine',
  },
  ...
  helpDesc: {
    ...
    defaultMessage: 'Help us improve warmachine by reporting issues or requesting new features',
  },
  ...
  updatesDesc: {
    ...
    defaultMessage: 'Check for and install updates to keep warmachine running at its best',
  },
  ...
  notificationsMacStep3: {
    ...
    defaultMessage: 'Find and select warmachine in the application list',
  },
...
export default function AppSettingsSection({ scrollToSection }: AppSettingsSectionProps) {
  ...
  const shouldShowUpdates = !window.appConfig.get('WARMACHINE_VERSION');
  ...
  return (
    <div className="space-y-4 pr-4 pb-8 mt-1">
      ...
      {/* Version Section - only show if WARMACHINE_VERSION is set */}
      {!shouldShowUpdates && (
        <Card className="rounded-lg">
          <CardHeader className="pb-0">
          ...
          <CardContent className="pt-4 px-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-2xl font-mono text-black dark:text-white">
                {String(window.appConfig.get('WARMACHINE_VERSION') || 'Development')}
              </span>
            </div>
          </CardContent>
        </Card>
      ...
      {/* Update Section - only show if WARMACHINE_VERSION is NOT set */}
