# Internationalization (i18n) — WarMachine Desktop UI

This document describes the i18n infrastructure for the WarMachine Desktop UI (`ui/desktop/`).
...
2. **`WARMACHINE_LOCALE`** — explicit override from env/app config when the desktop setting is
   System Default
