...
const i18n = defineMessages({
  ...
  thinking: {
    ...
    defaultMessage: 'warmachine is thinking…',
  },
  streaming: {
    id: 'loadingGoose.streaming',
    defaultMessage: 'warmachine is working on it…',
  },
  waiting: {
    id: 'loadingGoose.waiting',
    defaultMessage: 'warmachine is waiting…',
  },
  compacting: {
    id: 'loadingGoose.compacting',
    defaultMessage: 'warmachine is compacting the conversation...',
  },
  idle: {
...
const STATE_ICONS: Record<ChatState, React.ReactNode> = {
  ...
  [ChatState.Streaming]: <WarMachine className="flex-shrink-0 w-4 h-4 animate-pulse" />,
