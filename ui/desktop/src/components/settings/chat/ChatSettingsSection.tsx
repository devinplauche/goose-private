...
import { WarmachinehintsSection } from './WarmachinehintsSection';
...
const i18n = defineMessages({
  ...
  modeDescription: {
    ...
    defaultMessage:
      'Choose the default mode WarMachine uses for new sessions. Existing sessions keep their current mode.',
  },
  responseStylesTitle: {
  ...
  responseStylesDescription: {
    ...
    defaultMessage: 'Choose how WarMachine should format and style its responses',
  },
});
