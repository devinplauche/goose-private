...
warmachine is a general-purpose AI agent that runs on your machine. Not just for code — use it for research, writing, automation, data analysis, or anything you need to get done.

A native desktop app for macOS, Linux, and Windows. A full CLI for terminal workflows. An API to embed it anywhere. Built in Rust for performance and portability.

warmachine works with 15+ providers — Anthropic, OpenAI, Google, Ollama, OpenRouter, Azure, Bedrock, and more. Use API keys or your existing Claude, ChatGPT, or Gemini subscriptions via [ACP](https://goose-docs.ai/docs/guides/acp-providers). Connect to 70+ extensions via the [Model Context Protocol](https://modelcontextprotocol.io/) open standard.

warmachine is part of the [Agentic AI Foundation (AAIF)](https://aaif.io/) at the Linux Foundation.
...
- [Custom Distributions](https://github.com/aaif-goose/goose/blob/main/CUSTOM_DISTROS.md) — build your own warmachine distro with preconfigured providers, extensions, and branding
...
# a little warmachine humor 🪿

> Why did the developer choose warmachine as their AI agent?
> 
> Because it always helps them "migrate" their code to production! 🚀

# warmachine around with us
