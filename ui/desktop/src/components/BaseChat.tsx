...
export default function BaseChat({
  ...
  // (warmachine://new-session?prompt=...). Once the conversation has messages, later flows
  ...
  return (
    <div className="h-full flex flex-col min-h-0">
      ...
      >
        ...
        <div className="flex flex-col flex-1 min-h-0 relative">
          {/* WarMachine watermark - top right */}
          <div className="absolute top-[14px] right-4 z-[60] flex flex-row items-center gap-1">
            ...
            >
              <WarMachine className="size-5 goose-icon-animation" />
