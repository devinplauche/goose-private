...
const i18n = defineMessages({
  welcomeTitle: {
    ...
    defaultMessage: 'Welcome to warmachine',
  },
  welcomeDescription: {
  ...
  checkProviderErrorTitle: {
    ...
    defaultMessage: 'Unable to connect to WarMachine server',
  },
    ...
    return (
      <div className="h-screen w-full bg-background-default flex flex-col items-center justify-center">
        <div className="text-center max-w-md">
          <div className="mb-4">
            <WarMachine className="size-8 mx-auto" />
          </div>
