# warmachine Release Manual Testing Checklist
...
## Run the warmachine self-test recipe

warmachine run --recipe warmachine-self-test.yaml

## Have warmachine produce a test plan

Open the release candidate desktop app and have warmachine produce a test plan by pointing it at this PR. Use a prompt like
...
warmachine will produce a plan. Follow this plan to finish testing.
