...
describe('getLocale', () => {
  ...
  it('respects WARMACHINE_LOCALE over navigator.languages', () => {
    mockAppConfig({ WARMACHINE_LOCALE: 'en' });
    vi.stubGlobal('navigator', { languages: ['xx-XX'] });
    expect(getLocale()).toEqual({ locale: 'en', messageLocale: 'en' });
  });

  it('preserves regional tag from WARMACHINE_LOCALE', () => {
    mockAppConfig({ WARMACHINE_LOCALE: 'en-GB' });
    vi.stubGlobal('navigator', { languages: ['xx-XX'] });
  ...
  it('supports explicit Turkish locale', () => {
    mockAppConfig({ WARMACHINE_LOCALE: 'tr' });
    vi.stubGlobal('navigator', { languages: ['xx-XX'] });
  ...
  it('supports explicit Korean locale', () => {
    mockAppConfig({ WARMACHINE_LOCALE: 'ko' });
    vi.stubGlobal('navigator', { languages: ['xx-XX'] });
    expect(getLocale()).toEqual({ locale: 'ko', messageLocale: 'ko' });
  });

  it('supports POSIX-style Korean locale from WARMACHINE_LOCALE', () => {
    mockAppConfig({ WARMACHINE_LOCALE: 'ko_KR' });
    vi.stubGlobal('navigator', { languages: ['xx-XX'] });
    expect(getLocale()).toEqual({ locale: 'ko-KR', messageLocale: 'ko' });
  });
  ...
  it('supports POSIX-style Japanese locale from WARMACHINE_LOCALE', () => {
    mockAppConfig({ WARMACHINE_LOCALE: 'ja_JP' });
    vi.stubGlobal('navigator', { languages: ['xx-XX'] });
    expect(getLocale()).toEqual({ locale: 'ja-JP', messageLocale: 'ja' });
  });
  ...
  it('supports explicit Hindi locale', () => {
    mockAppConfig({ WARMACHINE_LOCALE: 'hi' });
    vi.stubGlobal('navigator', { languages: ['xx-XX'] });
  ...
  it('supports explicit Spanish locale', () => {
    mockAppConfig({ WARMACHINE_LOCALE: 'es' });
    vi.stubGlobal('navigator', { languages: ['xx-XX'] });
